...
class OrganizationMembershipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create organization_membership" do
    assert_difference("OrganizationMembership.count") do
      post organization_memberships_url, params: { organization_membership: { organization_id: @organization_membership.organization_id, user_id: @organization_membership.user_id } }
    end
  ...
  test "should update organization_membership" do
    patch organization_membership_url(@organization_membership), params: { organization_membership: { organization_id: @organization_membership.organization_id, user_id: @organization_membership.user_id } }
