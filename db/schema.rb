...
ActiveRecord::Schema[7.0].define(version: 2022_11_19_134023) do
  ...
  create_table "event_memberships", force: :cascade do |t|
    ...
    t.index ["organization_membership_id"], name: "index_event_memberships_on_organization_membership_id"
  end
  ...
  add_foreign_key "event_memberships", "organization_memberships"
